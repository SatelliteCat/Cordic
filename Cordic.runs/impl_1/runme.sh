...
HD_PWD='C:/Users/Liam/Documents/GitHub/Cordic/Cordic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CORDIC_MUL.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CORDIC_MUL.tcl -notrace
