...
HD_PWD='C:/Users/Liam/Documents/GitHub/Cordic/Cordic.runs/TRIG_LUT_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TRIG_LUT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TRIG_LUT.tcl
