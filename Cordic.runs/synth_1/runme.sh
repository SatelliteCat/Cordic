...
HD_PWD='C:/Users/Liam/Documents/GitHub/Cordic/Cordic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CORDIC_MUL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CORDIC_MUL.tcl
