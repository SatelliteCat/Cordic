...
#
# Generated by Vivado on Tue Dec 19 10:41:21 -0500 2017
# IP Build 1909766 on Thu Jun 15 19:58:00 MDT 2017 
#
# usage: TRIG_LUT.sh [-help]
# usage: TRIG_LUT.sh [-lib_map_path]
# usage: TRIG_LUT.sh [-noclean_files]
# usage: TRIG_LUT.sh [-reset_run]
#
# ********************************************************************************************************

xv_path="E:/xilinx/Vivado/2017.2"
...
# Script info
echo -e "TRIG_LUT.sh - Script generated by export_simulation (Vivado v2017.2 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot TRIG_LUT xil_defaultlib.TRIG_LUT -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim TRIG_LUT -key {Behavioral:sim_1:Functional:TRIG_LUT} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./TRIG_LUT.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
{
  file="xsim.ini"
  lib_map_path="E:/xilinx/Vivado/2017.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb TRIG_LUT.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./TRIG_LUT.sh -help\" for more information)\n"
    exit 1
  fi
